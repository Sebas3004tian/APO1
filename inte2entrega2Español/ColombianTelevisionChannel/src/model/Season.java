...
public class Season{
	...
	public Season(int x,int cantEpiPro,int cantEpiPub,int dia,int mes,int ano,String trailer) {
	//public Season(int x,int [] cantEpiProgramados,int [] cantEpiPublicados,int [] diaArray,int [] mesArray,int [] anoArray,String [] trailerArray){
		...
		this.cantEpiProgramados = cantEpiPro;
		this.cantEpiPublicados = cantEpiPub;
		fechaEstrenoTemporada = new Date(dia,mes,ano);
