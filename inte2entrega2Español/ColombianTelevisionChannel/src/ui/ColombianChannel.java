...
public class ColombianChannel {
    ...
    */
	...
	public void listarSeries(){
		System.out.println(channels.listarSerie());
	}
	public void listarPelículas(){
		boolean out = false;
		do{
			System.out.println("Ingresa la categoria de pepiculas que quieres ver listadas : ");
			...
			if(!out){
				System.out.println(channels.listarPeliculasCategoria(categoria));
				out=true;
			}
		}while(!out);
	}
	...
	public void crearTemporada(){
		...
		int cantEpiPub=0;
		String trailer="";
		System.out.println("Ingresa el nombre de la serie, para agregar una temporada :");
		sc.nextLine();
		String nombreSerie=sc.nextLine();
		if(channels.validarNombreSerie(nombreSerie)){
			
			
			System.out.println("Ingresa el numero de episodios programados para la temporada : ");
			...
			if(!out){
				...
				System.out.println("Ingresa el numero de episodios publicados para la temporada : ");
					...
					if(!out){
						...
						if(!out){
							...
							if(!out){
								...
								channels.crearOtraTemporada(nombreSerie,cantEpiPro,cantEpiPub,dia,mes,ano,trailer);
	...
	public void inforProducto(){
		System.out.println("Ingresa el nombre del producto que quieres buscar:");
		sc.nextLine();
		String nombreProducto=sc.nextLine();
		System.out.println(channels.buscarProducto(nombreProducto));
					...
					if(!out){
						...
						if(!out){
							...
							if(!out){
								...
								if(channels.validarNombreProducto(nombreProducto)){
									System.out.println(" ERROR ese nombre ya se encuentra registrado");
									out=true;
								}
								if(!out){
									...
									if(!out){
										...
										if(!out){
											...
											sc.nextLine();
											trailer=sc.nextLine();
											channels.addProduct(tipoProducto,nameDirector,sinopsis,dia,mes,ano,nombreProducto,productora,edadMinima,categoria,trailer,todosProtagonistas,censurada,motivo,cantEpiPro,cantEpiPub);
									...
									if(!out){
										...
										if(!out){
											...
											if(!out){
												...
												cantEpiPublicados = new int [numTemporadasSerie];
												diaArray = new int [numTemporadasSerie];
												mesArray = new int [numTemporadasSerie];
												anoArray = new int [numTemporadasSerie];
												trailerArray = new String [numTemporadasSerie];*/
												...
												/*for(int i=0;i<numTemporadasSerie;i++){
													...
													if(!out){
														...
														if(!out){
															cantEpiPublicados[i] = cantEpiPub;
															...
															if(!out){
																...
																if(!out){
																	...
																	if(!out){
																		...
																		channels.addProduct(tipoProducto,nameDirector,sinopsis,dia,mes,ano,nombreProducto,productora,edadMinima,categoria,trailer,todosProtagonistas,censurada,motivo,numTemporadasSerie,numTemporada,cantEpiPro,cantEpiPub);
