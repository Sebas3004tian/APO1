...
public class Movie extends Product {
	...
	public Movie(String nameDirector,String productora,String sinopsis,int day,int month,int year,String tituloOriginal,int edadMinima,String trailer,int categoria){
